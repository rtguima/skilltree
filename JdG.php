...
<br>
<center>
<h5><p>Jaboatão dos Guararapes PE</p>
...
// Contador de Usuarios
    $count_dados = $lnk->query('SELECT count(hardware) FROM dados_usuarios WHERE hardware != "" AND status = "Ativo" AND filial = "Jaboatão dos Guararapes PE" ');
...
// Contador de Desktops
    $count_desktops = $lnk->query('SELECT count(hardware) FROM dados_usuarios WHERE hardware like "Desktop" AND status = "Ativo" AND filial = "Jaboatão dos Guararapes PE" ');
...
// Contador de Notebooks
    $count_notebooks = $lnk->query('SELECT count(hardware) FROM dados_usuarios WHERE hardware like "Notebook" AND status = "Ativo" AND filial = "Jaboatão dos Guararapes PE" ');
...
// Contador de Numeros Corporativos
    $count_ncelular = $lnk->query('SELECT count(numero_celular) FROM dados_usuarios WHERE numero_celular > "" AND status = "Ativo" AND filial = "Jaboatão dos Guararapes PE" ');
...
//Consulta de tabela Dados Usuarios
    $result_bd_user = 'SELECT * FROM dados_usuarios WHERE status = "Ativo" AND filial = "Jaboatão dos Guararapes PE" ORDER BY nome ASC';
