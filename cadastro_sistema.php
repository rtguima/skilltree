...
<center>
    ...
    <form action="cadastro.php" method="post">
        ...
        <div class="tabs-container">
                        ...
                        <tr>
                            <td>Status:</td>
                                ...
                                <select id=status name="status">
                                    ...
                                    <option value="Fora da Rede">Fora da Rede</option>
                                    <option value="Grupo de E-mail">Grupo de E-mail</option>
                                </select>
                            *</td>
                        </tr>
                        </tr>
            ...
            <div>
                <center>
                    <table width="680" height="300" align="left" border="0" cellspacing="0" class="tabela">
                        <tr>
                        ...
                        <tr>
                            <td>Whatsapp:</td>
                            <td><input type="text" name="numero_celular_pessoal" maxlength="15" size="15" /></td>
                        </tr>

                        <tr>
                            <td>Skype:</td>
                            <td><input type="text" name="contato_skype" maxlength="50" size="50" /></td>
                        </tr>
