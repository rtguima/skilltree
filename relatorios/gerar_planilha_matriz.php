...
<html lang="pt-br">
    ...
    $lnk = mysqli_connect('localhost','root','', 'intranet_sistemas') or die(mysqli_error()) or die ('Nao foi possível conectar ao MySql: ' . mysqli_error($lnk));
		...
		$arquivo = 'inventario_hardware_matriz.xls';
		
		// Criamos uma tabela HTML com o formato da planilha
		$html = '';
		$html .= '<table border="1">';
		$html .= '<tr>';
		$html .= '<td colspan="17">Inventario de Hardware Matriz</tr>';
		$html .= '</tr>';
		...
		$result_msg_contatos = "SELECT * FROM dados_usuarios WHERE status != 'Desligado' AND filial = 'Matriz' ORDER BY nome ASC";
