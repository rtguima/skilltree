...
// Contador de Usuarios
    $count_dados = $lnk->query('SELECT count(hardware) FROM dados_usuarios WHERE hardware != "" AND status = "Ativo" AND filial = "Imperatriz MA" ');
...
// Contador de Desktops
    $count_desktops = $lnk->query('SELECT count(hardware) FROM dados_usuarios WHERE hardware like "Desktop" AND status = "Ativo" AND filial = "Imperatriz MA" ');
...
// Contador de Notebooks
    $count_notebooks = $lnk->query('SELECT count(hardware) FROM dados_usuarios WHERE hardware like "Notebook" AND status = "Ativo" AND filial = "Imperatriz MA" ');
...
// Contador de Numeros Corporativos
    $count_ncelular = $lnk->query('SELECT count(numero_celular) FROM dados_usuarios WHERE numero_celular > "" AND status = "Ativo" AND filial = "Imperatriz MA" ');
...
//Consulta de tabela Dados Usuarios
    $result_bd_user = 'SELECT * FROM dados_usuarios WHERE status = "Ativo" AND filial = "Imperatriz MA" ORDER BY nome ASC';
