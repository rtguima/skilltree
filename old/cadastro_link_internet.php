...
<main>
<center>
    <h3>Cadastrar Link de Internet</h3>
    <br>
</center>
                ...
                <center>
                    <table width="600" height="210" align="left" border="0" cellspacing="0" class="tabela">
                        ...
                        <tr>
                            <td>Status:</td>
                                <td>
                                <select id=status_internet name="status_internet">
                                    <option value=""></option>
                        ...
                        <tr>
                            <td>Filial:</td>
                                <td>
                                <select id=filial_internet name="filial_internet">
                                    <option value=""></option>
                        ...
                        <tr>
                            <td>CNPJ Cadastrado:</td>
                            <td><input type="text" id="cnpj_internet" name="cnpj_internet" maxlength="18" size="20"></td>
                        </tr>

                        <tr>
                            <td>Telefone Filial:</td>
                            <td><input type="text" id="telefone_internet" name="telefone_internet" maxlength="10" size="20"></td>                      
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id=departamento name="departamento">
                                    ...
                                    <option value="Gestão de Planejamento">Gestão de Planejamento</option>
                        ...
                        <tr>
                            <td>Cargo:</td>
                            <td><input type="text" name="cargo" maxlength="50" size="40" /></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id=office name="office">
                                    ...
                                    <option value="2019 Home and Business">2019 Home and Business</option>
                                </select>
                            </td>
                        </tr>                        
