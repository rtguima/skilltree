...
?>
    ...
    <a href="relatorios\gerar_planilha_desligados.php"><button type='button' class='btn btn-sm btn-success'>Gerar Excel</button></a>
...
//Consulta de tabela Dados Usuarios
    $result_bd_user = 'SELECT * FROM dados_usuarios WHERE status = "Desligado" ORDER BY nome ASC';
